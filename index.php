...
<div id="page-wrapper">
    <div class="row"> 
                ...
                <div class="row h-100 align-items-center">
                    <div class="col-lg-12">
                        <div class="text-white">
                            ...
                            Guide you Home</h1><!-- Developed By Shubham Sahane -->
        ...
        <div class="full-row bg-gray">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12"><!-- Developed By Shubham Sahane -->
        ...
        <div class="full-row">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12"><!-- Developed By Shubham Sahane -->
                        <div class="tab-content mt-4" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-4"><!-- Developed By Shubham Sahane -->
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p> First we show property to Customer And discuss about Property cost and customer requirements.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>After property finalise, we verify property documents and customer documents to process dealS.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>after documentation complete we handover the property to the customer.</p>
                        </div>
                    </div>
                </div>
            </div>
